...
// Define the EventArgs-dervied type for this event.
...
internal class TypeWithLotsOfEvents
{
    ...
    protected EventSet EventSet { get { return m_events; } }
    ...
    {
        add { m_events.Add(s_fooEventKey, value); }
        remove { m_events.Remove(s_fooEventKey, value); }
    }

    // 2e. Define the protected, virtual On method for this event.
    protected virtual void OnFoo(FooEventArgs e)
    {
        m_events.Raise(s_fooEventKey, this, e);
    }
    ...
    {
        add { m_events.Add(s_barEventKey, value); }
        remove { m_events.Remove(s_barEventKey, value); }
    }

    // 3e. Define the protected, virtual On method for this event.
    protected virtual void OnBar(BarEventArgs e)
    {
        m_events.Raise(s_barEventKey, this, e);
    }
