...
internal sealed class NewMailEventArgs : BarEventArgs
{
...
internal class MailManager
{
    ...
    {
        // Constuct a MailManager object
        MailManager mm = new MailManager();

        //Contruct a Fax object passing it the MailManager object
        Fax fax = new Fax(mm);
        ...
        // Simulate an incoming mail massage
    ...
    protected virtual void OnNewMail(NewMailEventArgs e)
    {
        ...
        // EventHandler is a predefined delegate type in the FCL
        // System.EventHandler 定义如下
...
internal sealed class Fax
{
    ...
    private void FaxMsg(object sender, NewMailEventArgs e)
    {
        ...
        Console.WriteLine("Faxing new e-mail message:");
        Console.WriteLine("From: {0}", e.From);
        Console.WriteLine("To: {0}", e.To);
        Console.WriteLine("Subject: {0}", e.Subject);
    }
